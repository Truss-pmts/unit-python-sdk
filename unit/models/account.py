...
class DepositAccountDTO(object):
    def __init__(self, id: str, created_at: datetime, name: str, deposit_product: str, routing_number: str,
                 ...
                 daca_status: Optional[DacaStatus] = None):
        self.id = id
        ...
        self.attributes = {"name": name, "createdAt": created_at, "updatedAt": updated_at,
                           ...
                           "fraudReason": fraud_reason, "dacaStatus": daca_status, "tags": tags}
    ...
    def from_json_api(_id, _type, attributes, relationships):
        ...
        return DepositAccountDTO(
            ...
            close_reason=attributes.get("closeReason"),
            relationships=relationships,
            updated_at=updated_at,
            freeze_reason=attributes.get("freezeReason"),
            fraud_reason=attributes.get("fraudReason"),
