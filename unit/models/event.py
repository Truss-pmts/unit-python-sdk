...
class CheckPaymentCreatedEvent(BaseEvent):
    def __init__(self, id: str, created_at: datetime, status: str, additional_verification_required: bool,
                 tags: Optional[Dict[str, str]], relationships: Optional[Dict[str, Relationship]]):
        BaseEvent.__init__(self, id, created_at, tags, relationships)
        self.type = 'checkPayment.created'
        self.attributes["status"] = status
        self.attributes["additionalVerificationRequired"] = additional_verification_required

    @staticmethod
    def from_json_api(_id, _type, attributes, relationships):
        return CheckPaymentCreatedEvent(_id, date_utils.to_datetime(attributes["createdAt"]),
                                        attributes["status"], attributes["additionalVerificationRequired"],
                                        attributes.get("tags"), relationships)
...
class CheckPaymentProcessedEvent(BaseEvent):
    def __init__(self, id: str, created_at: datetime, previous_status: str, additional_verification_required: bool, tags: Optional[Dict[str, str]],
                 relationships: Optional[Dict[str, Relationship]]):
        BaseEvent.__init__(self, id, created_at, tags, relationships)
    ...
    def from_json_api(_id, _type, attributes, relationships):
        return CheckPaymentProcessedEvent(_id, date_utils.to_datetime(attributes["createdAt"]),
                                          attributes["previousStatus"], attributes["additionalVerificationRequired"],
                                          attributes.get("tags"), relationships)
...
class CheckPaymentReturnToSenderEvent(BaseEvent):
    ...
    @staticmethod
    def from_json_api(_id, _type, attributes, relationships):
        return CheckPaymentReturnToSenderEvent(_id, date_utils.to_datetime(attributes["createdAt"]), attributes["status"],
                                          attributes["previousStatus"], attributes.get("tags"), relationships)
...
class PaymentCanceledUppercaseEvent(BaseEvent):
    def __init__(self, id: str, created_at: datetime, previous_status: str, direction: str, amount: int,
                 tags: Optional[Dict[str, str]], relationships: Optional[Dict[str, Relationship]]):
        BaseEvent.__init__(self, id, created_at, tags, relationships)
        self.type = 'payment.Canceled'
        self.attributes["previousStatus"] = previous_status
    ...
    @staticmethod
    def from_json_api(_id, _type, attributes, relationships):
        return PaymentCanceledUppercaseEvent(
            _id,
            date_utils.to_datetime(attributes["createdAt"]),
            attributes["previousStatus"],
...
EventDTO = Union[
    ...
    CustomerCreatedEvent, PaymentClearingEvent, PaymentSentEvent, PaymentReturnedEvent, PaymentCanceledEvent, PaymentCanceledUppercaseEvent,
